...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(0, this.width / 2 - 101, (int) (yPosition + 294), 100, 20, "Settings"));
        this.buttonList.add(new GuiButton(4, this.width / 2 + 1, (int) (yPosition + 294), 100, 20, "Exit game..."));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        RenderingUtils.drawImg(new ResourceLocation("Images/background1.png"), 0, 0, width, height);
        RenderingUtils.drawImg(new ResourceLocation("Images/logosmooth.png"), ((double) width / 2) - 150, yPosition + 30, 300, 300);
